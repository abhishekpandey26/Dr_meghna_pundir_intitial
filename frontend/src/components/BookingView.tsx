                      ...
                      {daysInGrid.map((dateObj, idx) => {
                        ...
                        return (
                          <button
                            ...
                            className={`aspect-square flex flex-col items-center justify-center text-xs font-bold transition-all relative ${
                              !selectable 
                            ...
                            {slotsStatus.map((slot) => {
                              ...
                              return (
                                <button
                                  ...
                                  className={`py-3 px-2 rounded-xl text-[10px] font-bold tracking-wider transition-all text-center ${
                                    isBooked 
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <input 
                          ...
                          placeholder="abhishekkumarpandey383@gmail.com"
                          className="w-full bg-neutral-50 border border-neutral-200 rounded-xl py-3 px-4 text-xs font-bold outline-none focus:ring-2 focus:ring-purple-900/5"
                        />
                  ...
                  <motion.div key="step4" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <button
                        ...
                        className={`w-full text-left p-6 rounded-2xl border transition-all flex flex-col justify-between h-40 ${
                          paymentMethod === 'ONLINE' 
                          ? 'border-[#8A256E] bg-purple-50/30 text-[#8A256E]' 
                          : 'border-neutral-200 hover:border-purple-200 hover:bg-neutral-50/50'
                        }`}
